...
\includegraphics[width=.95\textwidth,height=.8\textheight,keepaspectratio]{inputs-models-inference} 
...
\includegraphics[width=.95\textwidth,height=.5\textheight,keepaspectratio]{qr_img} 
...
github.com/mbjoseph/wildfire-extremes
