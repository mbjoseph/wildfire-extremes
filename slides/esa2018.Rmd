...
plot_jpeg('https://upload.wikimedia.org/wikipedia/commons/f/f4/SUPERSTITIONS_AZ15.jpg')
```
...
```{r, fig.width = 6, fig.height = 4}
plot_jpeg("https://upload.wikimedia.org/wikipedia/commons/6/6d/Mullica_River_5.jpg")
```
