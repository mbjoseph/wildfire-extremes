...
Overall, 95\% posterior predictive interval coverage in the test set for burn areas was 92.6\%.
<!-- lowest test set coverage -->
<!-- percent over, percent under -->
<!-- biggest discrepancy -->
...
\caption{Posterior 99\% prediction intervals for the burn area of the largest fire event by month and level 3 ecoregion in the test set, shown for ecoregions with the largest number of fire events. Empirical maxima are shown as black dots.}
