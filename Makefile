...
data/processed/ecoregion_summaries.csv: R/get-ecoregion-summaries.R  \
	data/raw/us_eco_l3/us_eco_l3.shp R/aggregate-climate-data.R
...
data/processed/housing_density.csv: R/summarize-housing-density.R \
	data/raw/us_eco_l3 data/raw/us_pbg00_2007.gdb
...
data/raw/us_eco_l3/us_eco_l3.shp: R/fetch-fire-data.R
